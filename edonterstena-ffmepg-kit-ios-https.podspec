...
Pod::Spec.new do |s|
  s.name         = "edonterstena-ffmpeg-kit-ios-https"
  s.version      = "6.0.2"
  ...
  s.source       = { :http => "https://github.com/edonterstena/ffmpeg-kit/releases/download/v6.0.2-edonterstena/ffmpeg-kit-https-6.0-ios-xcframework.zip"}
