...
Pod::Spec.new do |s|
  s.name         = "edonterstena-ffmpeg-kit-ios-full-gpl"
  s.version      = "6.0"
  ...
  s.source       = { :http => "https://github.com/edonterstena/ffmpeg-kit/releases/download/v6.0-edonterstena/ffmpeg-kit-ios-full-gpl-6.0-ios-xcframework.zip"}
